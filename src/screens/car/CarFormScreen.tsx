...
type CarFormScreenProps = {
    onSave: (data: CarForm) => void;
    defaultValues: CarForm;
    loading: boolean;
    title: string;
}

export const CarFormScreen = (props: CarFormScreenProps) => {

    const { onSave, defaultValues, loading, title, } = props;
